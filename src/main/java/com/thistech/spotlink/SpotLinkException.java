...
public class SpotLinkException extends RuntimeException {

    public SpotLinkException() {
    }

    public SpotLinkException(String s) {
        super(s);
    }

    public SpotLinkException(String s, Throwable throwable) {
        super(s, throwable);
    }

    public SpotLinkException(Throwable throwable) {
        super(throwable);
    }
}
