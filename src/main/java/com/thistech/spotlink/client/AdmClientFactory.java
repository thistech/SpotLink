...
import org.scte.wsdl._130_3._2010.adm.ADM;

public class AdmClientFactory extends AbstractClientFactory<ADM> {

    private static AdmClientFactory instance;

    public static AdmClientFactory instance() {
        if (instance == null) {
            instance = new AdmClientFactory();
        }
        return instance;
    }

    protected AdmClientFactory() {
        super(ADM.class, "/wsdl/adm_2010.wsdl");
    }
}
